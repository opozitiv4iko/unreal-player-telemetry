...
#include "Panda_Controller.generated.h"


UCLASS()
class GAMESTECHCOURSEWORK_API APanda_Controller : public AAIController
{
	GENERATED_BODY()

public:
	APanda_Controller(FObjectInitializer const& A_PObjectInit);
