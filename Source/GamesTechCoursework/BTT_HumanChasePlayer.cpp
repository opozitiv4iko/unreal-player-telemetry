...
#include "BTT_HumanChasePlayer.h"
...
UBTT_HumanChasePlayer::UBTT_HumanChasePlayer(FObjectInitializer const& A_PObjectInit)
{
	// Set the node name to "Chase Player"
	NodeName = TEXT("Chase Player");
}

EBTNodeResult::Type UBTT_HumanChasePlayer::ExecuteTask(UBehaviorTreeComponent& A_PTreeComp, uint8* A_PNodeMem)
{
	// Get AI Controller
	...
	FVector TargetLocation = PAIController->GetBlackboard()->GetValueAsVector(HumanKeys::TargetLocation);
